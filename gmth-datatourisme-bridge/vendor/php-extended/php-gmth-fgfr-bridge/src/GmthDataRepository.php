...
class GmthDataRepository extends GmthDataAbstractRepository
{
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeActiviteById()
	 */
	public function removeActiviteById($id)
	{
		$this->_activites_loaded = false;
		parent::removeActiviteById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllActivites()
	 */
	public function removeAllActivites()
	{
		$this->_activites_loaded = false;
		parent::removeAllActivites();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAvisDecisionById()
	 */
	public function removeAvisDecisionById($id)
	{
		$this->_avis_decision_loaded = false;
		parent::removeAvisDecisionById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllAvisDecision()
	 */
	public function removeAllAvisDecision()
	{
		$this->_avis_decision_loaded = false;
		parent::removeAllAvisDecision();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeCategorieById()
	 */
	public function removeCategorieById($id)
	{
		$this->_categories_loaded = false;
		parent::removeCategorieById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllCategories()
	 */
	public function removeAllCategories()
	{
		$this->_categories_loaded = false;
		parent::removeAllCategories();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeCiviliteById()
	 */
	public function removeCiviliteById($id)
	{
		$this->_civilites_loaded = false;
		parent::removeCiviliteById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllCivilites()
	 */
	public function removeAllCivilites()
	{
		$this->_civilites_loaded = false;
		parent::removeAllCivilites();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeCommuneById()
	 */
	public function removeCommuneById($id)
	{
		$this->_communes_loaded = false;
		parent::removeCommuneById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllCommunes()
	 */
	public function removeAllCommunes()
	{
		$this->_communes_loaded = false;
		parent::removeAllCommunes();
	}
	...
	{
		$this->_departements_loaded = false;
		parent::removeDepartementById($id);
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeEtatById()
	 */
	public function removeEtatById($id)
	{
		$this->_etats_loaded = false;
		parent::removeEtatById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllEtats()
	 */
	public function removeAllEtats()
	{
		$this->_etats_loaded = false;
		parent::removeAllEtats();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeGrilleCandidatureById()
	 */
	public function removeGrilleCandidatureById($id)
	{
		$this->_grilles_candidature_loaded = false;
		parent::removeGrilleCandidatureById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllGrillesCandidature()
	 */
	public function removeAllGrillesCandidature()
	{
		$this->_grilles_candidature_loaded = false;
		parent::removeAllGrillesCandidature();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeGrilleEvaluationById()
	 */
	public function removeGrilleEvaluationById($id)
	{
		$this->_grilles_evaluation_loaded = false;
		parent::removeGrilleEvaluationById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllGrillesEvaluation()
	 */
	public function removeAllGrillesEvaluation()
	{
		$this->_grilles_evaluation_loaded = false;
		parent::removeAllGrillesEvaluation();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeRegionById()
	 */
	public function removeRegionById($id)
	{
		$this->_regions_loaded = false;
		parent::removeRegionById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllRegions()
	 */
	public function removeAllRegions()
	{
		$this->_regions_loaded = false;
		parent::removeAllRegions();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeTypeClassementById()
	 */
	public function removeTypeClassementById($id)
	{
		$this->_types_classement_loaded = false;
		parent::removeTypeClassementById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllTypesClassement()
	 */
	public function removeAllTypesClassement()
	{
		$this->_types_classement_loaded = false;
		parent::removeAllTypesClassement();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeTypeDemandeById()
	 */
	public function removeTypeDemandeById($id)
	{
		$this->_types_demande_loaded = false;
		parent::removeTypeDemandeById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllTypesDemande()
	 */
	public function removeAllTypesDemande()
	{
		$this->_types_demande_loaded = false;
		parent::removeAllTypesDemande();
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeTypePieceJointeById()
	 */
	public function removeTypePieceJointeById($id)
	{
		$this->_types_piece_jointe_loaded = false;
		parent::removeTypePieceJointeById($id);
	}
	
	/**
	 * {@inheritDoc}
	 * @see \PhpExtended\Gmth\GmthDataAbstractRepository::removeAllTypesPieceJointe()
	 */
	public function removeAllTypesPieceJointe()
	{
		$this->_types_piece_jointe_loaded = false;
		parent::removeAllTypesPieceJointe();
	}
