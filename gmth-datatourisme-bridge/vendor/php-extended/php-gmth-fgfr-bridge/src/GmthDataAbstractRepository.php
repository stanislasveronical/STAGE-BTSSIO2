...
// 			throw new GmthApiException('Empty id for given api activite.');
	...
	/**
	 * Deletes the activite with the given id, if found.
	 * 
	 * @param string $id
	 */
	public function removeActiviteById($id)
	{
		unset($this->_activites[$id]);
	}
	
	/**
	 * Deletes all the activites stored into this repository.
	 */
	public function removeAllActivites()
	{
		$this->_activites = array();
	}
...
// 			throw new GmthApiException('Empty id for given api avis.');
	...
	/**
	 * Deletes the avis with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeAvisById($id)
	{
		unset($this->_avis[$id]);
	}
	
	/**
	 * Deletes all the avis stored into this repository.
	 */
	public function removeAllAviss()
	{
		$this->_avis = array();
	}
...
// 			throw new GmthApiException('Empty id for api avis decision.');
	...
	/**
	 * Deletes the avis decision with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeAvisDecisionById($id)
	{
		unset($this->_avis_decision[$id]);
	}
	
	/**
	 * Deletes all the avis decision stored into this repository.
	 */
	public function removeAllAvisDecision()
	{
		$this->_avis_decision = array();
	}
...
// 			throw new GmthApiException('Empty id for api candidat.');
	...
	/**
	 * Deletes the candidat with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeCandidatById($id)
	{
		unset($this->_candidats[$id]);
	}
	
	/**
	 * Deletes all the candidat stored into this repository.
	 */
	public function removeAllCandidats()
	{
		$this->_candidats = array();
	}
...
// 			throw new GmthApiException('Empty id for api candidature.');
	...
	/**
	 * Deletes the candidature with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeCandidatureById($id)
	{
		unset($this->_candidatures[$id]);
	}
	
	/**
	 * Deletes all the candidature stored into this repository.
	 */
	public function removeAllCandidatures()
	{
		$this->_candidatures = array();
	}
...
// 			throw new GmthApiException('Empty id for api categorie.');
	...
	/**
	 * Deletes the categories with the given id, if found.
	 *
	 * @param string $id
	 */
	...
	/**
	 * Deletes all the categories stored into this repository.
	 */
...
// 			throw new GmthApiException('Empty id for api civilite.');
	...
	/**
	 * Deletes the civilites with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeCiviliteById($id)
	{
		unset($this->_civilites[$id]);
	}
	
	/**
	 * Deletes all the civilites stored into this repository.
	 */
	public function removeAllCivilites()
	{
		$this->_civilites = array();
	}
...
// 			throw new GmthApiException('Empty id for api commune.');
	...
	/**
	 * Deletes the commune with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeCommuneById($id)
	{
		unset($this->_communes[$id]);
	}
	
	/**
	 * Deletes all the communes stored into this repository.
	 */
	public function removeAllCommunes()
	{
		$this->_communes = array();
	}
...
// 			throw new GmthApiException('Empty id for api decision.');
	...
	/**
	 * Deletes the decision with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeDecisionById($id)
	{
		unset($this->_decisions[$id]);
	}
	
	/**
	 * Deletes all the decisions stored into this repository.
	 */
	public function removeAllDecisions()
	{
...
// 			throw new GmthApiException('Empty id for api demande.');
	...
	/**
	 * Deletes the demande with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeDemandeById($id)
	{
		unset($this->_demandes[$id]);
	}
	
	/**
	 * Deletes all the activites stored into this repository.
	 */
	public function removeAllDemandes()
	{
		$this->_demandes = array();
	}
...
// 			throw new GmthApiException('Empty code for api departement.');
	...
	/**
	 * Deletes the departement with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeDepartementById($id)
	{
		unset($this->_departements[$id]);
	}
	
	/**
	 * Deletes all the departements stored into this repository.
	 */
	public function removeAllDepartements()
	{
		$this->_departements = array();
	}
...
// 			throw new GmthApiException('Empty id for api etablissement');
	...
	/**
	 * Deletes the etablissement with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeEtablissementById($id)
	{
		unset($this->_etablissements[$id]);
	}
	
	/**
	 * Deletes all the etablissements stored into this repository.
	 */
	public function removeAllEtablissements()
	{
		$this->_etablissements = array();
	}
...
// 			throw new GmthApiException('Empty id for api etat');
	...
	/**
	 * Deletes the etat with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeEtatById($id)
	{
		unset($this->_etats[$id]);
	}
...
// 			throw new GmthApiException('Empty id for api evaluation.');
		if(isset($this->_evaluations[$apiEvaluation->getId()]))
			$evaluation = $this->_evaluations[$apiEvaluation->getId()];
		else
		{
		...
		{
			if(!empty($apiEvaluation->getGrilleEvaluation()->getId()))
				$evaluation->grille_evaluation_id = $apiEvaluation->getGrilleEvaluation()->getId();
	...
	/**
	 * Deletes the evaluation with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeEvaluationById($id)
	{
		unset($this->_evaluations[$id]);
	}
	
	/**
	 * Deletes all the evaluations stored into this repository.
	 */
	public function removeAllEvaluations()
	{
...
// 			throw new GmthApiException('Empty id for api grille candidature.');
	...
	/**
	 * Deletes the grille candidature with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeGrilleCandidatureById($id)
	{
		unset($this->_grilles_candidature[$id]);
	}
	
	/**
	 * Deletes all the grilles candidature stored into this repository.
	 */
	public function removeAllGrillesCandidature()
	{
		$this->_grilles_candidature = array();
	}
...
// 			throw new GmthApiException('Empty id for api grille evaluation.');
	...
	/**
	 * Deletes the grille evaluation with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeGrilleEvaluationById($id)
	{
		unset($this->_grilles_evaluation[$id]);
	}
	
	/**
	 * Deletes all the grilles evaluation stored into this repository.
	 */
	public function removeAllGrillesEvaluation()
	{
		$this->_grilles_evaluation = array();
	}
...
// 			throw new GmthApiException('Empty id for api observation.');
	...
	/**
	 * Deletes the observation with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeObservationById($id)
	{
		unset($this->_observations[$id]);
	}
	
	/**
	 * Deletes all the observations stored into this repository.
	 */
...
// 			throw new GmthApiException('Empty id for api piece jointe.');
	...
	/**
	 * Deletes the piece jointe with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removePieceJointeById($id)
	{
		unset($this->_piece_jointes[$id]);
	}
	
	/**
	 * Deletes all the pieces jointes stored into this repository.
	 */
	public function removeAllPieceJointes()
	{
		$this->_piece_jointes = array();
	}
...
// 			throw new GmthApiException('Empty id for api region.');
	...
	/**
	 * Deletes the region with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeRegionById($id)
	{
		unset($this->_regions[$id]);
	}
	
	/**
	 * Deletes all the regions stored into this repository.
	 */
...
// 			throw new GmthApiException('Empty id for api type classement.');
	...
	/**
	 * Deletes the types classement with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeTypeClassementById($id)
	{
		unset($this->_types_classement[$id]);
	}
	
	/**
	 * Deletes all the types classement stored into this repository.
	 */
	public function removeAllTypesClassement()
	{
		$this->_types_classement = array();
	}
...
// 			throw new GmthApiException('Empty id for api type decision.');
	...
	/**
	 * Deletes the types decision with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeTypeDecisionById($id)
	{
		unset($this->_types_decision[$id]);
	}
	
	/**
	 * Deletes all the types decision stored into this repository.
	 */
	public function removeAllTypesDecision()
	{
		$this->_types_decision = array();
	}
...
// 			throw new GmthApiException('Empty id for api type demande.');
	...
	/**
	 * Deletes the types demande with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeTypeDemandeById($id)
	{
		unset($this->_types_demande[$id]);
	}
	
	/**
	 * Deletes all the types demande stored into this repository.
	 */
	public function removeAllTypesDemande()
	{
		$this->_types_demande = array();
	}
...
// 			throw new GmthApiException('Empty id for api type piece jointe.');
	...
	/**
	 * Deletes the types piece jointe with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeTypePieceJointeById($id)
	{
		unset($this->_types_piece_jointe[$id]);
	}
	
	/**
	 * Deletes all the types piece jointe stored into this repository.
	 */
	public function removeAllTypesPieceJointe()
	{
		$this->_types_piece_jointe = array();
	}
...
// 			throw new GmthApiException('Empty id for api utilisateur.');
	...
	/**
	 * Deletes the utilisateur with the given id, if found.
	 *
	 * @param string $id
	 */
	public function removeUtilisateurById($id)
	{
		unset($this->_utilisateurs[$id]);
	}
	
	/**
	 * Deletes all the utilisateurs stored into this repository.
	 */
	public function removeAllUtilisateurs()
	{
		$this->_utilisateurs = array();
	}
